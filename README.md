...
## Screenshots 
**chat_with_memory_response.png**
Demonstrates how the chatbot uses stored user identity and long-term memory to generate personalized responses.
<img width="1906" height="1037" alt="MCBot 1" src="https://github.com/user-attachments/assets/dfe8c75a-9599-4ab1-a496-55d59c158464" />
**memory_recall_previous_context.png**
Shows the chatbot recalling information from previous interactions using FAISS-based vector memory.
<img width="1893" height="973" alt="MCBot 2" src="https://github.com/user-attachments/assets/c5cc85e0-0a63-4e65-9091-0d2c90abe2e6" />
**suggestions_and_related_memories.png**
Displays top-K relevant memories retrieved from FAISS embeddings and shown as contextual suggestions.
